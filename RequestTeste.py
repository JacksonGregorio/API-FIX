...
class FixClientRequestTeste:
    ...
    def create_market_data_request_msg(self, symbol):
        self.fix_generator = simplefix.FixMessage()
        self.fix_generator.append_pair(8, "FIX.4.4")
        ...
        self.fix_generator.append_pair(262, "1")  
        self.fix_generator.append_pair(263, "0")  
    ...
    def request_market_data(self, symbol):
        market_data_request_msg = self.create_market_data_request_msg(symbol)
        self.send_fix_msg(market_data_request_msg)
...
if __name__ == "__main__":
    ...
    pricing_client = FixClientRequestTeste("fixapidcrd.squaredfinancial.com", 10210, "MD019", "DCRD", "100019", "87MTgLw345dfb!")
    pricing_client.logon()

    trading_client = FixClientRequestTeste("fixapidcrd.squaredfinancial.com", 10211, "TD019", "DCRD", "100019", "87MTgLw23wfe!")
    trading_client.logon()

    try:
        while True:
            pricing_client.request_market_data("EURUSD")
